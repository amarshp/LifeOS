-- Voice path: a timer switched away under a minute after starting was a
-- mis-speak — delete it instead of leaving sub-minute dust (mirrors the
-- client and agent switch paths). Only the stop-everything block changes;
-- the rest of _voice_track_core is identical to 20260704_001.
